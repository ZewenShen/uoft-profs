...
headers = {
    ...
    'Referer': 'https://course-evals.utoronto.ca/BPI/fbview.aspx?blockid=tWCtQDNS7F0gu',
...
def extract_eval_data(tr_tag):
    ...
    return {
        ...
        "instructor": "{} {}".format(td_taglist[2].getText()[0], td_taglist[3].getText()), # the instructor column in Course database table only have initial first name instead of full name
        "instructorFullName": "{} {}".format(td_taglist[2].getText(), td_taglist[3].getText()),
        ...
        "enthusiasm": None,
        "workload": td_taglist[12].getText(),
        "recommend": td_taglist[13].getText(),
        "numInvited": td_taglist[16].getText(),
        "numResponded": td_taglist[17].getText()
    }
